      ...
      if (userBooking) {
        ...
        return new Response(
          JSON.stringify({
            ...
            message: "You have already booked the one time 3+ Subscription Package for New Advertisers. We'll direct you to your account where you can place further bookings",
