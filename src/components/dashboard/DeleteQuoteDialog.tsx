        ...
        <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
          ...
          <div className="space-y-1 text-sm text-gray-600">
            <div className="flex justify-between">
              ...
              <span className="font-medium">{quote.pricing_model === 'bogof' ? '3+ Subscription Package' : quote.pricing_model === 'fixed' || quote.pricing_model === 'fixed_term' ? 'Pay As You Go' : quote.pricing_model === 'leafleting' ? 'Leaflet Distribution' : quote.pricing_model}</span>
            </div>
            <div className="flex justify-between">
