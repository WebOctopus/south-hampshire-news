...
const CalculatorTest = () => {
  ...
  return <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Header Section - Video Focused */}
      <section className="relative bg-community-navy overflow-hidden h-[70vh] flex items-center justify-center">
        {/* Background Video - Full Focus */}
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-community-navy/20 via-transparent to-community-navy/40" />
      ...
      {/* Key Stats Section - Glassmorphism Panel */}
      <section className="relative -mt-24 z-10 pb-12">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Glassmorphism Stats Panel */}
          <div className="relative bg-community-navy/80 backdrop-blur-xl rounded-2xl border border-white/20 p-6 lg:p-8 shadow-2xl">
            {/* Badge */}
            <div className="text-center mb-6">
              <Badge className="bg-transparent text-community-green border-community-green/50 px-4 py-1.5 text-sm">
            ...
            {/* Main Stat */}
            <div className="bg-white/10 rounded-xl p-6 text-center border border-white/10 mb-4">
              <div className="text-5xl lg:text-7xl font-heading font-bold text-white mb-2">142,000</div>
              <div className="text-community-green font-medium text-lg">Bi-monthly Circulation</div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="bg-white/5 rounded-xl p-4 text-center border border-white/10 hover:bg-white/10 transition-colors">
                <div className="text-3xl lg:text-4xl font-heading font-bold text-white mb-1">14</div>
                <div className="text-white/70 text-sm">Local Editions</div>
              </div>
              
              <div className="bg-white/5 rounded-xl p-4 text-center border border-white/10 hover:bg-white/10 transition-colors">
                <div className="text-3xl lg:text-4xl font-heading font-bold text-white mb-1">72%</div>
                <div className="text-white/70 text-sm">Repeat Rate</div>
              </div>
              
              <div className="bg-white/5 rounded-xl p-4 text-center border border-white/10 hover:bg-white/10 transition-colors">
                <div className="text-3xl lg:text-4xl font-heading font-bold text-white mb-1">250+</div>
                <div className="text-white/70 text-sm">Advertisers</div>
              </div>
              
              <div className="bg-white/5 rounded-xl p-4 text-center border border-white/10 hover:bg-white/10 transition-colors">
                <div className="text-3xl lg:text-4xl font-heading font-bold text-white mb-1">580k</div>
